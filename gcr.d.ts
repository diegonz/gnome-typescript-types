...
export function pkcs11_initialize_async(cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<(Gio.Cancellable | null)> | null): void;
...
export function trust_add_pinned_certificate_async(certificate: Certificate, purpose: string, peer: string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<Certificate> | null): void;
...
export function trust_is_certificate_anchored_async(certificate: Certificate, purpose: string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<Certificate> | null): void;

export function trust_is_certificate_anchored_finish(result: Gio.AsyncResult): boolean;

export function trust_is_certificate_distrusted(serial_nr: Uint8Array | string, issuer: Uint8Array | string, cancellable?: Gio.Cancellable | null): boolean;

export function trust_is_certificate_distrusted_async(serial_nr: Uint8Array | string, issuer: Uint8Array | string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<Uint8Array> | null): void;
...
export function trust_is_certificate_pinned_async(certificate: Certificate, purpose: string, peer: string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<Certificate> | null): void;
...
export function trust_remove_pinned_certificate_async(certificate: Certificate, purpose: string, peer: string, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<Certificate> | null): void;
