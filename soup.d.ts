...
export function form_decode_multipart(multipart: Multipart, file_control_name: string | null): [GLib.HashTable<string, string> | null, string, string, GLib.Bytes | null];
...
export function headers_parse_request(str: string, len: number, req_headers: MessageHeaders): [number, string, string, HTTPVersion | null];

export function headers_parse_response(str: string, len: number, headers: MessageHeaders): [boolean, HTTPVersion | null, number, string];
...
export function websocket_client_verify_handshake(msg: Message, supported_extensions?: GObject.TypeClass[] | null): [boolean, WebsocketExtension[] | null];
...
export function websocket_server_process_handshake(msg: ServerMessage, expected_origin?: string | null, protocols?: string[] | null, supported_extensions?: GObject.TypeClass[] | null): [boolean, WebsocketExtension[] | null];

export type AuthDomainBasicAuthCallback = (domain: AuthDomainBasic, msg: ServerMessage, username: string, password: string) => boolean;
export type AuthDomainDigestAuthCallback = (domain: AuthDomainDigest, msg: ServerMessage, username: string) => (string | null);
...
export type ServerCallback = (server: Server, msg: ServerMessage, path: string, query?: GLib.HashTable<string, string> | null) => void;
export type ServerWebsocketCallback = (server: Server, msg: ServerMessage, path: string, connection: WebsocketConnection) => void;
...
export class Message extends GObject.Object {
    ...
    emit(signal: 'content-sniffed', type: string, params: { [key: string]: any } | GLib.HashTable<string, string>): void;
