/* eslint-disable @typescript-eslint/adjacent-overload-signatures,@typescript-eslint/no-explicit-any,@typescript-eslint/no-unused-vars */
// noinspection SpellCheckingInspection

/**
 * Gtk 4.0
 *
 * Generated from 4.8.2
 */
...
export function accelerator_parse_with_keycode(accelerator: string, display: Gdk.Display | null): [boolean, number, number[] | null, Gdk.ModifierType | null];
...
export function editable_delegate_get_property(object: GObject.Object, prop_id: number, value: GObject.Value | any, pspec: GObject.ParamSpec): boolean;

export function editable_delegate_set_property(object: GObject.Object, prop_id: number, value: GObject.Value | any, pspec: GObject.ParamSpec): boolean;
...
export abstract class ATContext extends GObject.Object {
    ...
    protected constructor(properties?: Partial<ATContext.ConstructorProperties>, ...args: any[]);
...
export class AboutDialog extends Window implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export namespace AnyFilter {
    ...
    export interface ConstructorProperties<A extends GObject.Object = GObject.Object> extends MultiFilter.ConstructorProperties<A> {
        [key: string]: any;

    }
}

export class AnyFilter<A extends GObject.Object = GObject.Object> extends MultiFilter<A> implements Gio.ListModel<A>, Buildable {
...
export class AppChooserDialog extends Dialog implements Accessible, AppChooser, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export class ApplicationWindow extends Window implements Gio.ActionGroup, Gio.ActionMap, Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export class Assistant extends Window implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export class BookmarkList<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export class Box extends Widget implements Accessible, Buildable, ConstraintTarget, Orientable {
    ...
    pack_end(child: Widget, expand: boolean, align: boolean, fixed: boolean | number): void;

    pack_start(child: Widget, expand: boolean, align: boolean, fixed: boolean | number): void;
...
export class BuilderCScope extends GObject.Object implements BuilderScope {
    ...
    vfunc_create_closure(builder: Builder, function_name: string, flags: BuilderClosureFlags, object: GObject.Object): GObject.Closure;
...
export class CClosureExpression extends Expression {
    ...
    static ['new'](value_type: GObject.GType, marshal: GObject.ClosureMarshal | null, params: Expression[], callback_func: GObject.Callback, user_destroy?: GObject.ClosureNotify | null): CClosureExpression;
}
...
export abstract class CellArea extends GObject.InitiallyUnowned implements Buildable, CellLayout {
    ...
    protected constructor(properties?: Partial<CellArea.ConstructorProperties>, ...args: any[]);
    ...
    request_renderer(renderer: CellRenderer, orientation: Orientation, widget: Widget, for_size: number): [number, number];
    ...
    vfunc_get_cell_property(renderer: CellRenderer, property_id: number, value: GObject.Value | any, pspec: GObject.ParamSpec): void;
    ...
    vfunc_set_cell_property(renderer: CellRenderer, property_id: number, value: GObject.Value | any, pspec: GObject.ParamSpec): void;
...
export abstract class CellRenderer extends GObject.InitiallyUnowned {
    ...
    protected constructor(properties?: Partial<CellRenderer.ConstructorProperties>, ...args: any[]);
...
export class ClosureExpression extends Expression {
    ...
    static ['new'](value_type: GObject.GType, closure: GObject.Closure, params?: Expression[] | null): ClosureExpression;
}
...
export class ColorChooserDialog extends Dialog implements Accessible, Buildable, ColorChooser, ConstraintTarget, Native, Root, ShortcutManager {
...
export class ComboBoxText extends ComboBox implements Accessible, Buildable, CellEditable, CellLayout, ConstraintTarget {
...
export class DirectoryList<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export class DragSource extends GestureSingle {
    ...
    connect(signal: 'drag-cancel', callback: (_source: this, drag: Gdk.Drag, reason: Gdk.DragCancelReason) => boolean): number;

    connect_after(signal: 'drag-cancel', callback: (_source: this, drag: Gdk.Drag, reason: Gdk.DragCancelReason) => boolean): number;
    ...
    connect_after(signal: 'prepare', callback: (_source: this, x: number, y: number) => (Gdk.ContentProvider | null)): number;
...
export class DropTarget extends EventController {
    ...
    connect_after(signal: 'drop', callback: (_source: this, value: GObject.Value, x: number, y: number) => boolean): number;
...
export class DropTargetAsync extends EventController {
    ...
    connect(signal: 'drag-enter', callback: (_source: this, drop: Gdk.Drop, x: number, y: number) => Gdk.DragAction): number;

    connect_after(signal: 'drag-enter', callback: (_source: this, drop: Gdk.Drop, x: number, y: number) => Gdk.DragAction): number;
    ...
    connect(signal: 'drag-motion', callback: (_source: this, drop: Gdk.Drop, x: number, y: number) => Gdk.DragAction): number;

    connect_after(signal: 'drag-motion', callback: (_source: this, drop: Gdk.Drop, x: number, y: number) => Gdk.DragAction): number;
...
export abstract class EventController extends GObject.Object {
    ...
    protected constructor(properties?: Partial<EventController.ConstructorProperties>, ...args: any[]);
...
export class EveryFilter<A extends GObject.Object = GObject.Object> extends MultiFilter<A> implements Gio.ListModel<A>, Buildable {
...
export abstract class Expression {
    ...
    protected constructor(properties?: Partial<Expression.ConstructorProperties>, ...args: any[]);
...
export class FileChooserDialog extends Dialog implements Accessible, Buildable, ConstraintTarget, FileChooser, Native, Root, ShortcutManager {
...
export namespace FileChooserButton {
...
export class FileChooserButton extends FileChooserWidget {
    get_uri(): string;
...
export class FilterListModel<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export class FlattenListModel<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export class FlowBox extends Widget implements Accessible, Buildable, ConstraintTarget, Orientable {
    ...
    connect(signal: 'move-cursor', callback: (_source: this, step: MovementStep, count: number, extend: boolean, modify: boolean) => boolean): number;

    connect_after(signal: 'move-cursor', callback: (_source: this, step: MovementStep, count: number, extend: boolean, modify: boolean) => boolean): number;
...
export class FontChooserDialog extends Dialog implements Accessible, Buildable, ConstraintTarget, FontChooser, Native, Root, ShortcutManager {
...
export abstract class Gesture extends EventController {
    ...
    protected constructor(properties?: Partial<Gesture.ConstructorProperties>, ...args: any[]);
    ...
    connect(signal: 'sequence-state-changed', callback: (_source: this, sequence: Gdk.EventSequence | null, state: EventSequenceState) => void): number;

    connect_after(signal: 'sequence-state-changed', callback: (_source: this, sequence: Gdk.EventSequence | null, state: EventSequenceState) => void): number;
...
export class GestureClick extends GestureSingle {
    ...
    connect(signal: 'unpaired-release', callback: (_source: this, x: number, y: number, button: number, sequence: Gdk.EventSequence | null) => void): number;

    connect_after(signal: 'unpaired-release', callback: (_source: this, x: number, y: number, button: number, sequence: Gdk.EventSequence | null) => void): number;
...
export abstract class IMContext extends GObject.Object {
    ...
    protected constructor(properties?: Partial<IMContext.ConstructorProperties>, ...args: any[]);
...
export class IconView extends Widget implements Accessible, Buildable, CellLayout, ConstraintTarget, Scrollable {
    ...
    get_tooltip_context(x: number, y: number, keyboard_tip: boolean): [boolean, TreeModel | null, TreePath | null, TreeIter | null];
...
export abstract class LayoutChild extends GObject.Object {
    ...
    protected constructor(properties?: Partial<LayoutChild.ConstructorProperties>, ...args: any[]);
...
export abstract class LayoutManager extends GObject.Object {
    ...
    protected constructor(properties?: Partial<LayoutManager.ConstructorProperties>, ...args: any[]);
...
export abstract class ListBase extends Widget implements Accessible, Buildable, ConstraintTarget, Orientable, Scrollable {
    static $gtype: GObject.GType<ListBase>;


    protected constructor(properties?: Partial<ListBase.ConstructorProperties>, ...args: any[]);
...
export class ListBox extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    connect(signal: 'move-cursor', callback: (_source: this, object: MovementStep, p0: number, p1: boolean, p2: boolean) => void): number;

    connect_after(signal: 'move-cursor', callback: (_source: this, object: MovementStep, p0: number, p1: boolean, p2: boolean) => void): number;
...
export class MapListModel<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export abstract class MediaFile extends MediaStream implements Gdk.Paintable {
    ...
    protected constructor(properties?: Partial<MediaFile.ConstructorProperties>, ...args: any[]);
...
export abstract class MediaStream extends GObject.Object implements Gdk.Paintable {
    ...
    protected constructor(properties?: Partial<MediaStream.ConstructorProperties>, ...args: any[]);
...
export class MessageDialog extends Dialog implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export namespace MultiFilter {
    ...
    export interface ConstructorProperties<A extends GObject.Object = GObject.Object> extends Filter.ConstructorProperties {
        [key: string]: any;
...
export abstract class MultiFilter<A extends GObject.Object = GObject.Object> extends Filter implements Gio.ListModel<A>, Buildable {
    static $gtype: GObject.GType<MultiFilter>;


    protected constructor(properties?: Partial<MultiFilter.ConstructorProperties<A>>, ...args: any[]);
...
export class MultiSelection<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A>, SelectionModel<A> {
...
export namespace MultiSorter {
    ...
    export interface ConstructorProperties<A extends GObject.Object = GObject.Object> extends Sorter.ConstructorProperties {
        [key: string]: any;
...
export class MultiSorter<A extends GObject.Object = GObject.Object> extends Sorter implements Gio.ListModel<A>, Buildable {
...
export abstract class NativeDialog extends GObject.Object {
    ...
    protected constructor(properties?: Partial<NativeDialog.ConstructorProperties>, ...args: any[]);
...
export class NoSelection<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A>, SelectionModel<A> {
...
export namespace PageSetupUnixDialog {
...
export class PageSetupUnixDialog extends Dialog implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export namespace PasswordEntryBuffer {
...
export namespace PrintUnixDialog {
...
export class PrintUnixDialog extends Dialog implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export class SelectionFilterModel<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export abstract class ShortcutAction extends GObject.Object {
    ...
    protected constructor(properties?: Partial<ShortcutAction.ConstructorProperties>, ...args: any[]);
...
export namespace ShortcutController {
    ...
    export interface ConstructorProperties<A extends GObject.Object = GObject.Object> extends EventController.ConstructorProperties {
        [key: string]: any;
...
export class ShortcutController<A extends GObject.Object = GObject.Object> extends EventController implements Gio.ListModel<A>, Buildable {
...
export abstract class ShortcutTrigger extends GObject.Object {
    ...
    protected constructor(properties?: Partial<ShortcutTrigger.ConstructorProperties>, ...args: any[]);
...
export class ShortcutsWindow extends Window implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export class SingleSelection<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A>, SelectionModel<A> {
...
export class SliceListModel<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export class SortListModel<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export class SpinButton extends Widget implements Accessible, Buildable, CellEditable, ConstraintTarget, Editable, Orientable {
...
export class StringList<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A>, Buildable {
...
export class Text extends Widget implements Accessible, Buildable, ConstraintTarget, Editable {
    ...
    connect(signal: 'move-cursor', callback: (_source: this, step: MovementStep, count: number, extend: boolean) => void): number;

    connect_after(signal: 'move-cursor', callback: (_source: this, step: MovementStep, count: number, extend: boolean) => void): number;
...
export class TextBuffer extends GObject.Object {
    ...
    connect(signal: 'insert-paintable', callback: (_source: this, location: TextIter, paintable: Gdk.Paintable) => void): number;

    connect_after(signal: 'insert-paintable', callback: (_source: this, location: TextIter, paintable: Gdk.Paintable) => void): number;
...
export class TreeListModel<A extends GObject.Object = GObject.Object> extends GObject.Object implements Gio.ListModel<A> {
...
export class TreeView extends Widget implements Accessible, Buildable, ConstraintTarget, Scrollable {
    ...
    connect(signal: 'move-cursor', callback: (_source: this, step: MovementStep, direction: number, extend: boolean, modify: boolean) => boolean): number;

    connect_after(signal: 'move-cursor', callback: (_source: this, step: MovementStep, direction: number, extend: boolean, modify: boolean) => boolean): number;

    emit(signal: 'move-cursor', step: MovementStep, direction: number, extend: boolean, modify: boolean): void;

    connect(signal: 'row-activated', callback: (_source: this, path: TreePath, column: TreeViewColumn | null) => void): number;

    connect_after(signal: 'row-activated', callback: (_source: this, path: TreePath, column: TreeViewColumn | null) => void): number;
...
export class Bitset {
    ...
    constructor();
    constructor(properties?: Partial<unknown>);
...
export interface EditableNamespace {
    ...
    delegate_get_property(object: GObject.Object, prop_id: number, value: GObject.Value | any, pspec: GObject.ParamSpec): boolean;

    delegate_set_property(object: GObject.Object, prop_id: number, value: GObject.Value | any, pspec: GObject.ParamSpec): boolean;
