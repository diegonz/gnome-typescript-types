...
export function type_find_helper_for_data(obj: Gst.Object | null, data: Uint8Array | string): [Gst.Caps | null, Gst.TypeFindProbability | null];

export function type_find_helper_for_data_with_extension(obj: Gst.Object | null, data: Uint8Array | string, extension?: string | null): [Gst.Caps | null, Gst.TypeFindProbability | null];
...
export type CollectPadsCompareFunction = (pads: CollectPads, data1: CollectData, timestamp1: Gst.ClockTime, data2: CollectData, timestamp2: Gst.ClockTime) => number;
