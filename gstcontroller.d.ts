...
export type DirectControlBindingConvertGValue = (self: DirectControlBinding, src_value: number, dest_value: GObject.Value | any) => void;
export type DirectControlBindingConvertValue = (self: DirectControlBinding, src_value: number, dest_value?: any | null) => void;
