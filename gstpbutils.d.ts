...
export function codec_utils_h264_get_profile_flags_level(codec_data: Uint8Array | string): [boolean, number, number, number];

export function codec_utils_h265_caps_set_level_tier_and_profile(caps: Gst.Caps, profile_tier_level: Uint8Array | string): boolean;
...
export function codec_utils_mpeg4video_caps_set_level_and_profile(caps: Gst.Caps, vis_obj_seq: Uint8Array | string): boolean;
...
export function codec_utils_opus_parse_caps(caps: Gst.Caps): [boolean, number, number, number, number, number, Uint8Array | null];

export function codec_utils_opus_parse_header(header: Gst.Buffer): [boolean, number, number, number, number, number, Uint8Array | null, number, number];
