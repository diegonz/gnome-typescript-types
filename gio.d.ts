...
export function app_info_get_default_for_type_async(content_type: string, must_support_uris: boolean, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<string> | null): void;
...
export function app_info_get_default_for_uri_scheme_async(uri_scheme: string, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<string> | null): void;
...
export function file_new_tmp_async(tmpl: string | null, io_priority: number, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<(string | null)> | null): void;

export function file_new_tmp_dir_async(tmpl: string | null, io_priority: number, cancellable?: Cancellable | null, callback?: AsyncReadyCallback<(string | null)> | null): void;
...
export type DBusSubtreeDispatchFunc = (connection: DBusConnection, sender: string, object_path: string, interface_name: string, node: string, out_user_data: any) => (DBusInterfaceVTable | null);
export type DBusSubtreeEnumerateFunc = (connection: DBusConnection, sender: string, object_path: string) => string[];
export type DBusSubtreeIntrospectFunc = (connection: DBusConnection, sender: string, object_path: string, node: string) => (DBusInterfaceInfo[] | null);
...
export class Socket extends GObject.Object implements DatagramBased, Initable {
    ...
    send_message_with_timeout(address: SocketAddress | null, vectors: OutputVector[], messages: SocketControlMessage[] | null, flags: number, timeout_us: number, cancellable?: Cancellable | null): [PollableReturn, number];
