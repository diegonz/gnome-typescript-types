...
export function audio_channel_positions_to_mask(position: AudioChannelPosition[], force_order: boolean): [boolean, number];
...
export function audio_iec61937_payload(src: Uint8Array | string, dst: Uint8Array | string, spec: AudioRingBufferSpec, endianness: number): boolean;
...
export function audio_reorder_channels(data: Uint8Array | string, format: AudioFormat, from: AudioChannelPosition[], to: AudioChannelPosition[]): boolean;
...
export type AudioBaseSinkCustomSlavingCallback = (sink: AudioBaseSink, etime: Gst.ClockTime, itime: Gst.ClockTime, requested_skew: Gst.ClockTimeDiff, discont_reason: AudioBaseSinkDiscontReason) => void;
export type AudioClockGetTimeFunc = (clock: Gst.Clock) => Gst.ClockTime;
export type AudioFormatPack = (info: AudioFormatInfo, flags: AudioPackFlags, src: Uint8Array | string, data: Uint8Array | string, length: number) => void;
export type AudioFormatUnpack = (info: AudioFormatInfo, flags: AudioPackFlags, dest: Uint8Array | string, data: Uint8Array | string, length: number) => void;
