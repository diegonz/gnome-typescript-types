/* eslint-disable @typescript-eslint/no-unnecessary-type-constraint,@typescript-eslint/no-explicit-any,@typescript-eslint/no-shadow,@typescript-eslint/ban-types,@typescript-eslint/no-unused-vars */
// noinspection JSUnusedGlobalSymbols,TypeScriptRedundantGenericType,SpellCheckingInspection
...
export function atomic_pointer_compare_and_exchange_full(atomic: any, oldval: any | null, newval: any | null): [boolean, any];
...
export function convert_with_fallback(str: Uint8Array | string, to_codeset: string, from_codeset: string, fallback: string): [Uint8Array, number];
...
export function hash_table_contains(hash_table: { [key: string]: any } | HashTable<any, any>, key?: any | null): boolean;

export function hash_table_destroy(hash_table: { [key: string]: any } | HashTable<any, any>): void;

export function hash_table_insert(hash_table: { [key: string]: any } | HashTable<any, any>, key?: any | null, value?: any | null): boolean;

export function hash_table_lookup(hash_table: { [key: string]: any } | HashTable<any, any>, key?: any | null): any | null;

export function hash_table_lookup_extended(hash_table: { [key: string]: any } | HashTable<any, any>, lookup_key: any | null): [boolean, any, any];

export function hash_table_new_similar(other_hash_table: { [key: string]: any } | HashTable<any, any>): HashTable<any, any>;
...
export function hash_table_replace(hash_table: { [key: string]: any } | HashTable<any, any>, key?: any | null, value?: any | null): boolean;
...
export function hash_table_steal_extended(hash_table: { [key: string]: any } | HashTable<any, any>, lookup_key: any | null): [boolean, any, any];
...
export function spawn_async_with_pipes(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | null): [boolean, Pid | null, number, number, number];

export function spawn_async_with_pipes_and_fds(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | null, stdin_fd: number, stdout_fd: number, stderr_fd: number, source_fds: number[] | null, target_fds: number[] | null): [boolean, Pid | null, number, number, number];
...
export function spawn_sync(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | null): [boolean, Uint8Array | null, Uint8Array | null, number];
...
export function uri_split(uri_ref: string, flags: UriFlags): [boolean, string, string, string, number, string, string, string];

export function uri_split_network(uri_string: string, flags: UriFlags): [boolean, string, string, number];

export function uri_split_with_user(uri_ref: string, flags: UriFlags): [boolean, string, string, string, string, string, number, string, string, string];
...
type $ParseDeepVariantDict<State extends string, Memo extends Record<string, any> = {}> =
    string extends State
        ...
        // Hitting the first closing curly brace indicates the dictionary type is complete
...
export class Variant<S extends string = any> {
    ...
    static new_array<C extends string = 'a?'>(
        ...
        children: typeof child_type extends VariantType<any>
            ? Variant<$VariantTypeToString<any>>[]
            : Variant<C>[]
    ): Variant<`a${C}`>;
