...
export function debug_log_default(category: DebugCategory, level: DebugLevel, file: string, _function: string, line: number, object: GObject.Object | null, message: DebugMessage, user_data?: any | null): void;

export function debug_log_get_line(category: DebugCategory, level: DebugLevel, file: string, _function: string, line: number, object: GObject.Object | null, message: DebugMessage): string;

export function debug_log_literal(category: DebugCategory, level: DebugLevel, file: string, _function: string, line: number, object: GObject.Object | null, message_string: string): void;
...
export function meta_register(api: GObject.GType, impl: string, size: number, init_func: MetaInitFunction, free_func: MetaFreeFunction, transform_func: MetaTransformFunction): MetaInfo;
...
export function util_array_binary_search(array: any | null, num_elements: number, element_size: number, search_func: GLib.CompareDataFunc, mode: SearchMode, search_data?: any | null): any | null;
...
export function value_fraction_multiply(product: GObject.Value | any, factor1: GObject.Value | any, factor2: GObject.Value | any): boolean;

export function value_fraction_subtract(dest: GObject.Value | any, minuend: GObject.Value | any, subtrahend: GObject.Value | any): boolean;
...
export function value_intersect(value1: GObject.Value | any, value2: GObject.Value | any): [boolean, GObject.Value | null];
...
export function value_set_fraction_range(value: GObject.Value | any, start: GObject.Value | any, end: GObject.Value | any): void;

export function value_set_fraction_range_full(value: GObject.Value | any, numerator_start: number, denominator_start: number, numerator_end: number, denominator_end: number): void;
...
export function value_subtract(minuend: GObject.Value | any, subtrahend: GObject.Value | any): [boolean, GObject.Value | null];
...
export type ControlBindingConvert = (binding: ControlBinding, src_value: number, dest_value: GObject.Value | any) => void;
...
export type CustomMetaTransformFunction = (transbuf: Buffer, meta: CustomMeta, buffer: Buffer, type: GLib.Quark, data?: any | null) => boolean;
...
export type LogFunction<A = GObject.Object> = (category: DebugCategory, level: DebugLevel, file: string, _function: string, line: number, object: A, message: DebugMessage) => void;
...
export type MetaTransformFunction = (transbuf: Buffer, meta: Meta, buffer: Buffer, type: GLib.Quark, data?: any | null) => boolean;
...
export class Buffer {
    ...
    static new_wrapped_full(flags: MemoryFlags, data: Uint8Array | string, maxsize: number, offset: number, notify?: GLib.DestroyNotify | null): Buffer;
...
export class Memory {
    ...
    constructor(flags: MemoryFlags, data: Uint8Array | string, maxsize: number, offset: number, notify?: GLib.DestroyNotify | null);
    ...
    // Constructors
    static new_wrapped(flags: MemoryFlags, data: Uint8Array | string, maxsize: number, offset: number, notify?: GLib.DestroyNotify | null): Memory;
