...
export abstract class Font extends Pango.Font {
    ...
    // Conflicted with Pango.Font.get_languages
    get_languages(...args: never[]): any;
...
export module FontMap {
    ...
    export interface ConstructorProperties<A extends GObject.Object = GObject.Object> extends Pango.FontMap.ConstructorProperties<A> {
        [key: string]: any;

    }
}

export abstract class FontMap<A extends GObject.Object = GObject.Object> extends Pango.FontMap<A> implements Gio.ListModel<A> {
