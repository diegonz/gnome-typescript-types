/* eslint-disable @typescript-eslint/no-empty-interface,@typescript-eslint/no-misused-new */
...
export interface IAdjustment {
     ...
     * You should use this instead of using St.Adjustment.set_value
     * as this method will tweak the values directly using the same
     * math as GTK+, to ensure that scrolling is consistent across
     * the environment.
     *
     * @param delta A delta, retrieved directly from Clutter.event.get_scroll_delta
     *   or similar.
     */
    ...
    connect(signal: 'notify::lower', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::page-increment', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::page-size', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::step-increment', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::upper', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::value', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type AdjustmentInitOptionsMixin = Pick<IAdjustment,
    'lower' |
    'page_increment' |
    'page_size' |
    'step_increment' |
...
export type AdjustmentInitOptions = AdjustmentInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Adjustment instead.
 */
export type AdjustmentMixin = IAdjustment & GObject.Object & Clutter.Animatable;

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface Adjustment extends AdjustmentMixin {}
...
export interface IBin {
    /**
     * The child #ClutterActor of the Bin container.
     */
    child: Clutter.Actor | null;
    /**
     * The horizontal alignment of the Bin child.
     */
    x_align: Align;
    /**
    ...
    x_fill: boolean;
    /**
     * The vertical alignment of the Bin child.
     */
    y_align: Align;
    /**
     ...
     * inside a Bin, as set by St.Bin.set_alignment.
     *
    ...
    connect(signal: 'notify::child', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::x-align', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::x-fill', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::y-align', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::y-fill', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type BinInitOptionsMixin =
    WidgetInitOptions
    & Pick<IBin,
    'child' |
    'x_align' |
...
export type BinInitOptions = BinInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Bin instead.
 */
export type BinMixin =
    IBin
    & Widget
...
// @ts-ignore
// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface Bin extends BinMixin {}

export class Bin {
    public constructor(options?: Partial<BinInitOptions>);

    /**
     * Creates a new Bin, a simple container for one child.
     *
     * @returns the newly created Bin actor
     */
    public static new(): Widget;
}

/** This construct is only for enabling class multi-inheritance,
 * use BorderImage instead.
 */
export interface IBorderImage {
    /**
     * Check if two border_image objects are identical.
     *
     * @param other a different Border_Image
...
export type BorderImageInitOptionsMixin = unknown

export type BorderImageInitOptions = BorderImageInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use BorderImage instead.
 */
export type BorderImageMixin = IBorderImage & GObject.Object;

export interface BorderImage extends BorderImageMixin {
}
...
export interface IBoxLayout {
    ...
    /**
     * Get the value of the BoxLayout.pack_start property.
     *
    ...
    /**
     * Get the value of the BoxLayout.vertical property.
     *
    ...
    /**
     * Set the value of the BoxLayout.pack_start property.
     *
    ...
    /**
     * Set the value of the BoxLayout.vertical property
     *
     * @param vertical %TRUE if the layout should be vertical
     */
    set_vertical(vertical: boolean): void;

    connect(signal: 'notify::pack-start', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::vertical', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type BoxLayoutInitOptionsMixin =
    ViewportInitOptions
    & Pick<IBoxLayout,
    'pack_start' |
    'vertical'>;

export type BoxLayoutInitOptions = BoxLayoutInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use BoxLayout instead.
 */
export type BoxLayoutMixin =
    IBoxLayout
    & Viewport
    & Atk.ImplementorIface
    & Clutter.Animatable
 ...
 */
export interface BoxLayout extends BoxLayoutMixin {
}
...
export class BoxLayout {
     ...
     *
     * @returns a newly allocated BoxLayout
     */
    public static new(): Widget;
}

/** This construct is only for enabling class multi-inheritance,
 * use BoxLayoutChild instead.
 */
export interface IBoxLayoutChild {
    expand: boolean;
    x_align: Align;
    x_fill: boolean;
    y_align: Align;
    ...
    connect(signal: 'notify::expand', callback: (owner: this, ...args: Array<unknown>) => void): number;
...
export type BoxLayoutChildInitOptionsMixin = Pick<IBoxLayoutChild,
    'expand' |
    'x_align' |
    'x_fill' |
    'y_align' |
...
export type BoxLayoutChildInitOptions = BoxLayoutChildInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use BoxLayoutChild instead.
 */
export type BoxLayoutChildMixin = IBoxLayoutChild & Clutter.ChildMeta;

/**
 * The contents of this structure are private and should only be accessed
 * through the public API.
 */
export interface BoxLayoutChild extends BoxLayoutChildMixin {
}
...
export interface IButton {
    ...
    /**
     * Sets which mouse buttons #button emits Button.clicked for.
     *
    ...
    connect(signal: 'notify::button-mask', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::checked', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::label', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::pressed', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::toggle-mode', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type ButtonInitOptionsMixin =
    BinInitOptions
    & Pick<IButton,
    'button_mask' |
    'checked' |
...
export type ButtonInitOptions = ButtonInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Button instead.
 */
export type ButtonMixin =
    IButton
    & Bin
    & Atk.ImplementorIface
    & Clutter.Animatable
 ...
 * the provided API.
 */
export interface Button extends ButtonMixin {
}
...
export type ClipboardInitOptionsMixin = unknown

export type ClipboardInitOptions = ClipboardInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Clipboard instead.
 */
export type ClipboardMixin = IClipboard & GObject.Object;

/**
 * The contents of this structure is private and should only be accessed using
 * the provided API.
 */
export interface Clipboard extends ClipboardMixin {
}
...
export class Clipboard {
    ...
    /**
     * Get the global Clipboard object that represents the clipboard.
     *
     * @returns a Clipboard owned by St and must not be
...
export interface IDrawingArea {
     ...
     * Clutter.Actor.queue_redraw will simply result in the same
...
export type DrawingAreaInitOptionsMixin = WidgetInitOptions

export type DrawingAreaInitOptions = DrawingAreaInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use DrawingArea instead.
 */
export type DrawingAreaMixin =
    IDrawingArea
    & Widget
    & Atk.ImplementorIface
    & Clutter.Animatable
...
export interface DrawingArea extends DrawingAreaMixin {
}
...
export interface IEntry {
     ...
     *
     * @returns the #ClutterText used by Entry. The entry is
    ...
    connect(signal: 'notify::clutter-text', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::hint-text', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::text', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type EntryInitOptionsMixin = WidgetInitOptions
    & Pick<IEntry,
    'hint_text' |
    'text'>;

export type EntryInitOptions = EntryInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Entry instead.
 */
export type EntryMixin =
    IEntry
    & Widget
    & Atk.ImplementorIface
    & Clutter.Animatable
 ...
 * the provided API.
 */
export interface Entry extends EntryMixin {
}
...
export class Entry {
    ...
    /**
     * Create a new Entry with the specified entry
     *
     * @param text text to set the entry to
     * @returns a new Entry
     */
...
export type FocusManagerInitOptionsMixin = unknown

export type FocusManagerInitOptions = FocusManagerInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use FocusManager instead.
 */
export type FocusManagerMixin = IFocusManager & GObject.Object;

/**
 * The FocusManager struct contains only private data
 */
export interface FocusManager extends FocusManagerMixin {
}
...
export class FocusManager {
    ...
    /**
     * Gets the FocusManager for #stage, creating it if necessary.
     *
...
export type GroupInitOptionsMixin = WidgetInitOptions

export type GroupInitOptions = GroupInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Group instead.
 */
export type GroupMixin =
    IGroup
    & Widget
    & Atk.ImplementorIface
    & Clutter.Animatable
...
/**
 * The Group struct contains only private data
 */
export interface Group extends GroupMixin {
}
...
export interface IIcon {
    ...
    connect(signal: 'notify::gicon', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::icon-name', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::icon-size', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::icon-type', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type IconInitOptionsMixin = WidgetInitOptions
    & Pick<IIcon,
    'gicon' |
    'icon_name' |
    'icon_size' |
...
export type IconInitOptions = IconInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Icon instead.
 */
export type IconMixin =
    IIcon
    & Widget
    & Atk.ImplementorIface
    & Clutter.Animatable
 ...
 * through the public API.
 */
export interface Icon extends IconMixin {
}
...
export class Icon {
    ...
    /**
     * Create a newly allocated Icon
     *
     * @returns A newly allocated Icon
     */
...
export interface IImageContent {
    ...
    connect(signal: 'notify::preferred-height', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::preferred-width', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type ImageContentInitOptionsMixin = Pick<IImageContent,
    'preferred_height' |
    'preferred_width'>;

export type ImageContentInitOptions = ImageContentInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use ImageContent instead.
 */
export type ImageContentMixin = IImageContent & Clutter.Image & Clutter.Content;

export interface ImageContent extends ImageContentMixin {
}
...
export class ImageContent {
    ...
    /**
     * Creates a new ImageContent, a simple content for sized images.
     *
     ...
     * @returns the newly created ImageContent content
     *   Use GObject.unref when done.
     */
...
export interface ILabel {
     ...
     * Retrieve the internal #ClutterText so that extra parameters can be set
     *
     * @returns ethe #ClutterText used by Label. The label
...
export type LabelInitOptionsMixin = WidgetInitOptions
    & Pick<ILabel,
    'text'>;

export type LabelInitOptions = LabelInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Label instead.
 */
export type LabelMixin =
    ILabel
    & Widget
    & Atk.ImplementorIface
    & Clutter.Animatable
 ...
 * the provided API.
 */
export interface Label extends LabelMixin {
}
...
export class Label {
    ...
    /**
     * Create a new Label with the specified label
     *
     * @param text text to set the label to
     * @returns a new Label
     */
...
export interface IPolygon {
    ...
    connect(signal: 'notify::debug', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::llc-x', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::llc-y', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::lrc-x', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::lrc-y', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::ulc-x', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::ulc-y', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::urc-x', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::urc-y', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type PolygonInitOptionsMixin = Pick<IPolygon,
    'debug' |
    'llc_x' |
    'llc_y' |
    'lrc_x' |
...
export type PolygonInitOptions = PolygonInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Polygon instead.
 */
export type PolygonMixin =
    IPolygon
    & Clutter.Actor
    & Atk.ImplementorIface
    & Clutter.Animatable
...
export interface Polygon extends PolygonMixin {
}
...
export interface IScrollBar {
    ...
    connect(signal: 'notify::adjustment', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::vertical', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type ScrollBarInitOptionsMixin = WidgetInitOptions
    & Pick<IScrollBar,
    'adjustment' |
    'vertical'>;

export type ScrollBarInitOptions = ScrollBarInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use ScrollBar instead.
 */
export type ScrollBarMixin =
    IScrollBar
    & Widget
    & Atk.ImplementorIface
    & Clutter.Animatable
 ...
 * through the public API.
 */
export interface ScrollBar extends ScrollBarMixin {
}
...
export interface IScrollView {
    ...
    /**
     * Gets the value set by St.ScrollView.set_overlay_scrollbars.
     *
     * @returns
     */
    ...
    connect(signal: 'notify::enable-auto-scrolling', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::enable-mouse-scrolling', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::hscroll', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::hscrollbar-policy', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::hscrollbar-visible', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::overlay-scrollbars', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::vscroll', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::vscrollbar-policy', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::vscrollbar-visible', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type ScrollViewInitOptionsMixin = BinInitOptions & Pick<IScrollView,
...
export type ScrollViewInitOptions = ScrollViewInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use ScrollView instead.
 */
export type ScrollViewMixin =
    IScrollView
    & Bin
    & Atk.ImplementorIface
    & Clutter.Animatable
 ...
 * through the public API.
 */
export interface ScrollView extends ScrollViewMixin {
}
...
/** This construct is only for enabling class multi-inheritance,
 * use ScrollViewFade instead.
 */
export interface IScrollViewFade {
    /**
     * Whether the faded area should extend to the edges of the ScrollViewFade.
     */
    fade_edges: boolean;
    /**
    ...
    connect(signal: 'notify::fade-edges', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::hfade-offset', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::vfade-offset', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type ScrollViewFadeInitOptionsMixin = Pick<IScrollViewFade,
    'fade_edges' |
    'hfade_offset' |
    'vfade_offset'>;

export type ScrollViewFadeInitOptions = ScrollViewFadeInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use ScrollViewFade instead.
 */
export type ScrollViewFadeMixin = IScrollViewFade & Clutter.ShaderEffect;

export interface ScrollViewFade extends ScrollViewFadeMixin {
}
...
export class ScrollViewFade {
    ...
    /**
     * Create a new ScrollViewFade.
     *
     * @returns a new ScrollViewFade
     */
...
export interface ISettings {
    ...
    connect(signal: 'notify::font-name', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::gtk-icon-theme', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::magnifier-active', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type SettingsInitOptionsMixin = unknown

export type SettingsInitOptions = SettingsInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Settings instead.
 */
export type SettingsMixin = ISettings & GObject.Object;

export interface Settings extends SettingsMixin {
}
...
export interface ITable {
    ...
    connect(signal: 'notify::column-count', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::homogeneous', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::row-count', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type TableInitOptionsMixin =
    WidgetInitOptions
    & Pick<ITable,
    'homogeneous'>;

export type TableInitOptions = TableInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Table instead.
 */
export type TableMixin =
    ITable
    & Widget
    & Atk.ImplementorIface
    & Clutter.Animatable
 ...
 * the provided API.
 */
export interface Table extends TableMixin {
}
...
export interface ITableChild {
    ...
    connect(signal: 'notify::allocate-hidden', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::col', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::col-span', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::row', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::row-span', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::x-align', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::x-expand', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::x-fill', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::y-align', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::y-expand', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::y-fill', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type TableChildInitOptionsMixin = Pick<ITableChild,
    'allocate_hidden' |
    'col' |
    'col_span' |
    'row' |
...
export type TableChildInitOptions = TableChildInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use TableChild instead.
 */
export type TableChildMixin = ITableChild & Clutter.ChildMeta;

/**
 * The contents of the this structure are private and should only be accessed
 * through the public API.
 */
export interface TableChild extends TableChildMixin {
}
...
export interface ITextureCache {
     ...
     */
    load(key: string, policy: TextureCachePolicy, load: TextureCacheLoader): unknown;
     ...
     */
    load_file_to_cairo_surface(file_path: string): unknown;
     ...
     */
    load_file_to_cogl_texture(file_path: string): unknown;
     ...
     * @returns a new #cairo_surface_t
     */
    load_gfile_to_cairo_surface(file: Gio.File, paint_scale: number, resource_scale: number): unknown;
     ...
     * @returns a new #CoglTexture
     */
    load_gfile_to_cogl_texture(file: Gio.File, paint_scale: number, resource_scale: number): unknown;
     ...
     * asynchronously.
     *
     * @param theme_node The ThemeNode to use for colors, or NULL
    ...
    /**
     * Load a themed icon into a texture. See the IconType documentation
...
export type TextureCacheInitOptionsMixin = unknown

export type TextureCacheInitOptions = TextureCacheInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use TextureCache instead.
 */
export type TextureCacheMixin = ITextureCache & GObject.Object;

export interface TextureCache extends TextureCacheMixin {
}
...
export interface ITheme {
    ...
    connect(signal: 'notify::application-stylesheet', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::default-stylesheet', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::fallback-stylesheet', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::theme-stylesheet', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type ThemeInitOptionsMixin = unknown & Pick<ITheme,
    'application_stylesheet' |
    'default_stylesheet' |
    'fallback_stylesheet' |
    'theme_stylesheet'>;

export type ThemeInitOptions = ThemeInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Theme instead.
 */
export type ThemeMixin = ITheme & GObject.Object;

export interface Theme extends ThemeMixin {
}
...
export interface IThemeContext {
    ...
    connect(signal: 'notify::scale-factor', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type ThemeContextInitOptionsMixin = unknown & Pick<IThemeContext,
    'scale_factor'>;

export type ThemeContextInitOptions = ThemeContextInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use ThemeContext instead.
 */
export type ThemeContextMixin = IThemeContext & GObject.Object;

export interface ThemeContext extends ThemeContextMixin {
}
...
/** This construct is only for enabling class multi-inheritance,
 * use ThemeNode instead.
 */
export interface IThemeNode {
    /**
     * Adjusts a "for height" passed to Clutter.Actor.get_preferred_width to
    ...
    /**
     * Adjusts a "for width" passed to Clutter.Actor.get_preferred_height to
     * account for borders and padding. This is a convenience function meant
     ...
     * function meant to be called from the Get.preferred_height method
     ...
     * function meant to be called from the Get.preferred_width method
     * of a #ClutterActor subclass
     */
     ...
     *
     * @param other a different ThemeNode
     */
    copy_cached_paint_state(other: ThemeNode): void;

    /**
     * Compare two ThemeNodes. Two nodes which compare equal will match
     ...
     * specific getters (like St.ThemeNode.get_background_color) exist, they
     ...
     *  without units.
     *
     * See also St.ThemeNode.lookup_double, which provides more options,
     * and lets you handle the case where the theme does not specify the
     * indicated value.
     *
     ...
     * specific getters (like St.ThemeNode.get_border_width) exist, they
     * should be used instead. They are cached, so more efficient, and have
     * handling for shortcut properties and other details of CSS.
     *
     ...
     *
     * @returns the parent ThemeNode, or %NULL if this
     ...
     * specific getters (like St.ThemeNode.get_box_shadow) exist, they
     * should be used instead. They are cached, so more efficient, and have
     * handling for shortcut properties and other details of CSS.
     *
     ...
     * specifies the transition time between the previous ThemeNode
     * and #node.
     *
     ...
     *  without units.
     *
     * See also St.ThemeNode.get_double, which provides a simpler API.
     *
     * @param property_name The name of the numeric property
     * @param inherit if %TRUE, if a value is not found for the property on the
     *   node, then it will be looked up on the parent node, and then on the
     ...
     * handling for shortcut properties and other details of CSS.
     *
     * See also St.ThemeNode.get_shadow, which provides a simpler API.
     *
     * @param property_name The name of the shadow property
     * @param inherit if %TRUE, if a value is not found for the property on the
     *   node, then it will be looked up on the parent node, and then on the
    ...
    paint(framebuffer: unknown, box: Clutter.ActorBox, paint_opacity: number): void;

    /**
     * Check if St.ThemeNode.paint will paint identically for #node as it does
...
export type ThemeNodeInitOptionsMixin = unknown

export type ThemeNodeInitOptions = ThemeNodeInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use ThemeNode instead.
 */
export type ThemeNodeMixin = IThemeNode & GObject.Object;

export interface ThemeNode extends ThemeNodeMixin {
}
...
export class ThemeNode {
    ...
    /**
     * Creates a new ThemeNode. Once created, a node is immutable. Of any
...
export type ViewportInitOptionsMixin =
    WidgetInitOptions
    & ScrollableInitOptions

export type ViewportInitOptions = ViewportInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Viewport instead.
 */
export type ViewportMixin =
    IViewport
    & Widget
    & Atk.ImplementorIface
    & Clutter.Animatable
...
/**
 * The Viewport struct contains only private data
 */
export interface Viewport extends ViewportMixin {
}
...
export interface IWidget {
     ...
     * only tracked automatically if Widget.track_hover is %TRUE, but you can
     ...
     * Widget.hover property and "hover" style pseudo class will be
     ...
     * from the object itself (ie: a Button knows when it is pressed).
     ...
     * St.Widget.set_accessible_name for more information.
     *
     ...
     * St.Widget.set_accessible_role for more information.
     *
     ...
     * St.Widget.set_can_focus for more information.
     *
    ...
    /**
     * If Widget.track_hover is set, this returns whether the pointer
    ...
    /**
     * Get the current inline style string. See St.Widget.set_style.
     *
     ...
     *
     * @returns the class name string. The string is owned by the Widget and
     ...
     * St.Widget.has_style_pseudo_class.
     *
    ...
    /**
     * Gets the overriding theme set on the actor. See St.Widget.set_theme
     *
     ...
     * St.Widget.set_track_hover for more information.
     *
     ...
     * implied by #direction) that has the Widget.can_focus property
     ...
     * given direction, then St.Widget.navigate_focus will try a second
     ...
     * @returns %TRUE if Clutter.Actor.grab_key_focus has been
     ...
     * @param paint_context
     */
    paint_background(paint_context: unknown): void;
     ...
     * #widget. See St.Widget.add_accessible_state for more information.
     *
     ...
     * WidgetAccessible at the javascript code.
     *
     ...
     * for the widget. Next call of St.Widget.get_accessible would
     ...
     * object (ie: a Button has by default a push button role). This
     ...
     *
     * If you have set Widget.track_hover, you should not need to call
     * this directly. You can call St.Widget.sync_hover if the hover
     ...
     * names. See also St.Widget.add_style_class_name and
     ...
     * names. See also St.Widget.add_style_pseudo_class and
    ...
    /**
     * Enables hover tracking on the Widget.
     *
    ...
    connect(signal: 'notify::accessible-name', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::accessible-role', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::can-focus', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::hover', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::important', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::label-actor', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::pseudo-class', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::style', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::style-class', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::theme', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::track-hover', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type WidgetInitOptionsMixin = Pick<IWidget,
    'accessible_name' |
    'accessible_role' |
    'can_focus' |
    'hover' |
...
export type WidgetInitOptions = WidgetInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Widget instead.
 */
export type WidgetMixin =
    IWidget
    & Clutter.Actor
    & Atk.ImplementorIface
    & Clutter.Animatable
...
/**
 * Base class for stylable actors. The contents of the Widget
 * structure are private and should only be accessed through the
 * public API.
 */
export interface Widget extends WidgetMixin {
}
...
/** This construct is only for enabling class multi-inheritance,
 * use WidgetAccessible instead.
 */
export interface IWidgetAccessible {

}

export type WidgetAccessibleInitOptions = unknown

/** This construct is only for enabling class multi-inheritance,
 * use WidgetAccessible instead.
 */
export type WidgetAccessibleMixin = IWidgetAccessible & Atk.GObjectAccessible & Atk.Action & Atk.Component;

export interface WidgetAccessible extends WidgetAccessibleMixin {
}
...
/**
 * The IconColors structure encapsulates colors for colorizing a symbolic
 * icon.
 */
...
export class IconColors {
    ...
    /**
     * Creates a new IconColors. All colors are initialized to transparent black.
     *
     * @returns a newly created IconColors}. Free with St.IconColors.unref
     */
     ...
     * in #colors. You would use this function instead of St.IconColors.ref
     * if you were planning to change colors in the result.
     *
     * @returns a newly created IconColors.
     */
     ...
     *
     * @returns the passed in IconColors.
     */
...
export class Shadow {
     ...
     * @returns the newly allocated shadow. Use St.Shadow.free when done
     */
     ...
     * errors.
     *
     * @param other a different Shadow
...
export class ShadowHelper {
    ...
    /**
     * Builds a ShadowHelper that will build a drop shadow
     * using #source as the mask.
     *
     * @param shadow a Shadow representing the shadow properties
     * @returns a new ShadowHelper
     */
     ...
     */
    public paint(framebuffer: unknown, actor_box: Clutter.ActorBox, paint_opacity: number): void;
...
export interface IScrollable {
    ...
    connect(signal: 'notify::hadjustment', callback: (owner: this, ...args: Array<unknown>) => void): number;

    connect(signal: 'notify::vadjustment', callback: (owner: this, ...args: Array<unknown>) => void): number;

}

export type ScrollableInitOptionsMixin = Pick<IScrollable,
    'hadjustment' |
    'vadjustment'>;

export type ScrollableInitOptions = ScrollableInitOptionsMixin

/** This construct is only for enabling class multi-inheritance,
 * use Scrollable instead.
 */
export type ScrollableMixin = IScrollable;

export interface Scrollable extends ScrollableMixin {
}
 ...
 */
export interface TextureCacheLoadImageCallback {
    /**
     * Callback from st_texture_cache_load_image_from_file_async. The handle should match
     * the one returned by _load_image_from_file_async.
     *
     * @param cache a TextureCache
...
/**
 * See St.TextureCache.load.  Implementations should return a
 * texture handle for the given key, or set #error.
 */
export interface TextureCacheLoader {
    /**
     * See St.TextureCache.load.  Implementations should return a
     * texture handle for the given key, or set #error.
     *
     ...
     * @returns
     */
    (cache: TextureCache, key: string, data?: unknown | null): unknown;
}

/**
 * Creates a string describing #actor, for use in debugging. This
 * includes the class name and actor name (if any), plus if #actor
 * is an Widget, its style class and pseudo class names.
 *
 * @param {Clutter.Actor} actor a #ClutterActor
 ...
 *
 * @param {number} factor new slow-down factor
 */
