...
export function rtp_buffer_get_extension_onebyte_header_from_bytes(bytes: GLib.Bytes | Uint8Array, bit_pattern: number, id: number, nth: number): [boolean, Uint8Array];
...
export abstract class RTPBaseDepayload extends Gst.Element {
    ...
    connect(signal: 'request-extension', callback: (_source: this, ext_id: number, ext_uri: string | null) => RTPHeaderExtension): number;

    connect_after(signal: 'request-extension', callback: (_source: this, ext_id: number, ext_uri: string | null) => RTPHeaderExtension): number;
...
export abstract class RTPBasePayload extends Gst.Element {
    ...
    connect(signal: 'request-extension', callback: (_source: this, ext_id: number, ext_uri: string) => RTPHeaderExtension): number;

    connect_after(signal: 'request-extension', callback: (_source: this, ext_id: number, ext_uri: string) => RTPHeaderExtension): number;
...
export abstract class RTPHeaderExtension extends Gst.Element {
    ...
    vfunc_write(input_meta: Gst.Buffer, write_flags: RTPHeaderExtensionFlags, output: Gst.Buffer, data: Uint8Array | string): number;
