...
export function emoji_dict_lookup(dict: { [key: string]: any } | GLib.HashTable<string, EmojiData>, emoji: string): EmojiData;
...
export class Engine extends Service {
    ...
    connect(signal: 'process-hand-writing-event', callback: (_source: this, coordinates: any | null, coordinates_len: number) => void): number;

    connect_after(signal: 'process-hand-writing-event', callback: (_source: this, coordinates: any | null, coordinates_len: number) => void): number;
...
export class InputContext extends Proxy implements Gio.AsyncInitable<InputContext>, Gio.DBusInterface, Gio.Initable {
    ...
    connect(signal: 'update-preedit-text-with-mode', callback: (_source: this, text: Text, cursor_pos: number, visible: boolean, mode: number) => void): number;

    connect_after(signal: 'update-preedit-text-with-mode', callback: (_source: this, text: Text, cursor_pos: number, visible: boolean, mode: number) => void): number;
...
export class PanelService extends Service {
    ...
    connect(signal: 'candidate-clicked-lookup-table', callback: (_source: this, object: number, p0: number, p1: number) => void): number;

    connect_after(signal: 'candidate-clicked-lookup-table', callback: (_source: this, object: number, p0: number, p1: number) => void): number;
    ...
    connect(signal: 'set-cursor-location-relative', callback: (_source: this, x: number, y: number, w: number, h: number) => void): number;

    connect_after(signal: 'set-cursor-location-relative', callback: (_source: this, x: number, y: number, w: number, h: number) => void): number;
