...
export type HashDataFunc = (t_type: GObject.GType, t_dup_func: GObject.BoxedCopyFunc, v?: any | null) => number;
export type EqualDataFunc = (t_type: GObject.GType, t_dup_func: GObject.BoxedCopyFunc, a?: any | null, b?: any | null) => boolean;
export type LazyFunc = (g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc) => (any | null);
export type FoldMapFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, k_type: GObject.GType, k_dup_func: GObject.BoxedCopyFunc, v_type: GObject.GType, v_dup_func: GObject.BoxedCopyFunc, k?: any | null, v?: any | null, a?: any | null) => (any | null);
export type ForallMapFunc = (k_type: GObject.GType, k_dup_func: GObject.BoxedCopyFunc, v_type: GObject.GType, v_dup_func: GObject.BoxedCopyFunc, k?: any | null, v?: any | null) => boolean;
export type Task = (g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc) => (any | null);
export type FoldFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, g?: any | null, a?: any | null) => (any | null);
export type ForallFunc = (g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, g?: any | null) => boolean;
export type UnfoldFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc) => (Lazy | null);
export type StreamFunc = (g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, state: TraversableStream, g: Lazy | null) => TraversableStream;
export type MapFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, g?: any | null) => (any | null);
export type Predicate = (g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, g?: any | null) => boolean;
export type FlatMapFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, g?: any | null) => Iterator;
...
export module Future {
    export type MapFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, value?: any | null) => (any | null);
    export type LightMapFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, value?: any | null) => (any | null);
    export type ZipFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, b_type: GObject.GType, b_dup_func: GObject.BoxedCopyFunc, c_type: GObject.GType, c_dup_func: GObject.BoxedCopyFunc, a?: any | null, b?: any | null) => (any | null);
    export type FlatMapFunc = (a_type: GObject.GType, a_dup_func: GObject.BoxedCopyFunc, g_type: GObject.GType, g_dup_func: GObject.BoxedCopyFunc, value?: any | null) => Future;
}
