...
export function tag_list_add_id3_image(tag_list: Gst.TagList, image_data: Uint8Array | string, id3_picture_type: number): boolean;
...
export function tag_list_from_vorbiscomment(data: Uint8Array | string, id_data: Uint8Array | string): [Gst.TagList, string];

export function tag_list_from_vorbiscomment_buffer(buffer: Gst.Buffer, id_data: Uint8Array | string): [Gst.TagList, string];
...
export function tag_list_to_vorbiscomment_buffer(list: Gst.TagList, id_data: Uint8Array | string, vendor_string?: string | null): Gst.Buffer;

export function tag_list_to_xmp_buffer(list: Gst.TagList, read_only: boolean, schemas: string[]): Gst.Buffer;

export function tag_parse_extended_comment(ext_comment: string, fail_if_no_key: boolean): [boolean, string, string, string];
